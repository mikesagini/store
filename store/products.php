...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to our Fashion_Dynasty Store!</h1>
                    <p>We have the best clothing for you. No need to hunt around, we have all in one place.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/img41.jpg" alt="loafers">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Loafer shoes</h3>
                                    <p>Price: sh. 2499.00</p>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/img32.jpg" alt="loafer">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>black loafers</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/img31.jpg" alt="loafer">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>black</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/img25.jpg" alt="loafers">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Yellow</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/img22.jpg" alt="Boots">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Boots</h3>
                                    <p>Price: sh. 1700.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/img6.jpg" alt="Open shoes">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>open shoes</h3>
                                    <p>Price: sh. 1600.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/img11.JPG" alt="Dolly shoes">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Dolly shoes</h3>
                                    <p>Price: sh. 1300.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/img12.jpg" alt="converse">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Dolly shoe</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/img1.jpg" alt="sports shoe">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Sports</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/img42.jpg" alt="walker">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Walker</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/img3.jpg" alt="Sports">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Sports</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/img9.jpg" alt="Sports">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Sports</h3>
